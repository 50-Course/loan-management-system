...
urlpatterns = [
    path("loans/", LoanAdminViewSet.as_view({"get": "all_loans"})),
    path(
        "loans/<int:id>/", LoanAdminViewSet.as_view({"get": "retrieve_customer_loan"})
    ),
    ...
    path("loans/requests/", LoanApplicationViewSet.as_view({"get": "my_applications"})),
]
