# Generated by Django 5.2.4 on 2025-07-04 23:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(help_text="Customer's phone number - must be 11 digits, without the country code", max_length=11, unique=True)),
                ('date_of_birth', models.DateField(help_text="Customer's date of birth")),
            ],
            options={
